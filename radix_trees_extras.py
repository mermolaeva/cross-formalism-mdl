...
import json
from tries_extras import pprint_trie, make_trie, special_chars, special_mark
import re
...
def corpus_to_trie(corpus_name):
	...
	with open(f'radix_trees_{corpus_name}.txt', 'w', encoding='utf-8') as outfile: # compressed version
		outfile.write(s)
	
	with open(f'radix_trees_{corpus_name}.json', 'w', encoding='utf-8') as outfile: # uncompressed version
